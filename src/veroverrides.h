...
#define MAXVER_INTERNALNAME "asciiimp\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "asciiimp.dli\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "ASCII file importer (plugin)\0"//should  be overidden on a per-dll level
